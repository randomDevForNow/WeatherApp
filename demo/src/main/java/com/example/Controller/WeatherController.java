...
public class WeatherController {
    ...
    public void fetchWeatherAsync() {
        ...
        // Run weather fetching task asynchronously
    ...
    private void updateWeatherUI(String location, String temperature, String humidity, String windSpeed,
            String description) {
    ...
    private void setWeatherDescriptions(String condition) {
        condition = condition.toLowerCase(); // Normalize condition to lowercase
    ...
    private void updateWeatherIcon(String condition) {
        ...
        if (condition.contains("sunny")) {
            ...
            iconPath = "/com/example/loadingImage.png";
        } else if (condition.contains("cloudy")) {
    ...
    public void updateWeather(double latitude, double longitude) {
        String apiKey = "c3af45cbaff1d83a9472068c18ab76c2";
